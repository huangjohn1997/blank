...
(function () {
  ...
  T.eqs({
    ...
    ptrue: { t: 'P(the token that actually showed up)', b: '<p>This is the important bit of the whole objective. We don’t ask what the model’s favourite word was. We ask what it bet on the token that <em>actually happened</em>.</p><p>So a model can have the right favourite and still score badly by hedging, and it can have the wrong favourite and score fine by keeping the truth plausible.</p>' },
